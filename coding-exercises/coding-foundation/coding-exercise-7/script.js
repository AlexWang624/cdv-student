...
function gotData(incomingData) {
 ...
 var dataUSA = incomingData.filter(function(d) {
    return d[0].country === "United States"
  })

  var dataChina = incomingData.filter(function(d) {
     return d[0].country === "China"
   })

console.log("dataUSA", dataUSA)
console.log("dataUSA", dataChina)



  function showUSA() {
    graphGroup.selectAll(".line").data(dataUSA).enter()
      .append("path")
      .attr("d", lineMaker)
      .attr("fill", "none")
      .attr("stroke-width", 5)
      ...
      graphGroup.selectAll('.line').data(dataUSA).transition().duration(1000)
      .attr("d", lineMaker)
      .attr("stroke", "blue");
  ...
  function showChina() {
    graphGroup.selectAll(".line").data(dataChina).enter()
      .append("path")
      .attr("d", lineMaker)
      .attr("fill", "none")
      .attr("stroke-width", 5)
      ...
      graphGroup.selectAll('.line').data(dataChina).transition().duration(1000)
      .attr("d", lineMaker)
      .attr("stroke", "red");
